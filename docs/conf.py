...
project = "lsst-comet-interceptor-target-reduction"
copyright = "2024, parthenope-ap"
author = "parthenope-ap"
release = version("lsst-comet-interceptor-target-reduction")
